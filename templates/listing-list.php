...
<div class="woocommerce-page woocommerce">
    ...
    <div class="container">
      ...
      <div class="row product-table-heading">
          ...
          <div class="d-inline d-md-none col-md-2 product-image"><?php echo __( 'Image', 'mpc' ); ?></div>

          <div class="d-inline d-md-none col-md-4 product-name"><?php echo __( 'Product', 'mpc' ); ?></div>

          <div class="d-inline d-md-none col-4 col-md-2 product-price-top"><?php echo __( '4 Hour', 'mpc' ); ?></div>

          <div class="d-inline d-md-none col-4 col-md-2 product-price-top"><?php echo __( 'Daily', 'mpc' ); ?></div>

          <div class="d-inline d-md-none col-4 col-md-2 product-price-top"><?php echo __( 'Weekly', 'mpc' ); ?></div>
